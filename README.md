...
[version_shield]: https://img.shields.io/badge/version-0.1.0--indev07-informational.svg
[release_page]: https://github.com/mfederczuk/ktlint-gradle-plugin/releases/tag/v0.1.0-indev07 "Release v0.1.0-indev07"
[![version: 0.1.0-indev07][version_shield]][release_page]
...
buildscript {
	...
	dependencies {
		classpath("io.github.mfederczuk:ktlint-gradle-plugin:0.1.0-indev07")
	}
}
